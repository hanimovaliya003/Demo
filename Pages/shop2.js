...
//     const images = {
//         black: "Images/shop5.jpg",
//         green: "Images/shop6.jpg",
//         red: "Images/shop7.jpg",
//         white: "Images/shop4.jpg",
//     };
...
//     if (prices[color]) {
//         priceElement.innerHTML = `$${prices[color].toFixed(2)}`; 
//     } else {
...
//     changeImageAndPrice('white', 'productImage2', 'zoomContainer');
// };
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addToCartBtn.addEventListener("click", function () {
        ...
        const price = 145.50;
        const productName = "Bohemian Rhapsody Attire";
        const totalPrice = quantity * price;
        const imageUrl = "Images/shop4.jpg"; // Add the image URL
