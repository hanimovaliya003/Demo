...
function changeImage(color, imageId) {
    ...
    if (images[color]) {
        ...
        console.error('Image not found for color:shop8.jpg ' + black);
    }
}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addToCartBtn.addEventListener("click", function () {
        ...
        const price = 109.99;
        const productName = "Professional Pinstripe Blazer";
        const totalPrice = quantity * price;
        const imageUrl = "Images/shop12.jpg"; // Add the image URL
